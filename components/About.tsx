            ...
            return {
                ...
                content: (
                    <div className="text-zinc-400 leading-relaxed text-lg space-y-4">
                        ...
                        <p>I 2019 blev vi en del af OpenAIs research-brugere og fik adgang til GPT-2. Det betød at jeg har promptet med LLM'er siden 2019 (selvom vi dengang kaldte det NLG). Da GPT-3 blev lanceret i 2020, var jeg blandt de første i verden til at få adgang. Jeg så straks potentialet. Vi kunne nu få en AI til at træffe simple beslutninger for os. Det blev startskudet på mit første agentic system.</p>
                        <p>Et system der automatisk kunne foretage handlinger på vores brugeres vegne. Men modellerne er ikke super gode og med ekstrem små "tokens vinduer" (hele 2,048 tokens😅).Derfor kan jeg også tydeligt huske mit "ChatGPT moment", da instruct-modellerne kom i 2021: "Holy moly, dette kommer til at ændre ALT".</p>
